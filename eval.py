...
if __name__ == "__main__":
	...
	network.load_weights('/data/datasets/rbonatti/ml_weights_augmented_q1/weights.02-0.13.hdf5')
	...
	np.savetxt('/data/datasets/rbonatti/ml_prediction_augmented.out', predictions, delimiter=',')