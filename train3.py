...
save_models_dir= '/data/datasets/rbonatti/ml_weights3/'
...
if __name__ == "__main__":
    ...
    checkpointer = ModelCheckpoint(filepath="/data/datasets/rbonatti/ml_weights3/weights.{epoch:02d}-{val_loss:.2f}.hdf5", verbose=1)
